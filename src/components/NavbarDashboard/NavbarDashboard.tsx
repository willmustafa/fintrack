          ...
          <div className="offcanvas-body p-4 pt-0 p-lg-0">
            ...
            <ul className="navbar-nav flex-row flex-wrap ms-md-auto">
              ...
              <li className="nav-item dropdown">
                ...
                >
                  <span className="d-lg-none" aria-hidden="true">
                    Bootstrap
                  </span>
                  <span className="visually-hidden">Bootstrap&nbsp;</span> v5.3{" "}
                ...
                <ul className="dropdown-menu dropdown-menu-end">
                  <li>
                    <h6 className="dropdown-header">v5 releases</h6>
                  </li>
                  <li>
                    <a
                  ...
                  <li>
                    <h6 className="dropdown-header">Previous releases</h6>
                  </li>
                  <li>
                    <a
                      className="dropdown-item"
                  ...
                  <li>
                    <a className="dropdown-item" href="/docs/versions/">
                      All versions
                    </a>
                  </li>
                </ul>
